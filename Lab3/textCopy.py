...
import graphics
import time #todo take away later
...
def runTestsGraphics(ggame):
    ...
    test(len(circles) == 2, "there should be two circles drawn after running tests (found "+str(len(circles))+")")

    test(len(rectangles) == 2, "there should be two rectangles initially (found "+str(len(circles))+")")
